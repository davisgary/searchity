    ...
    <div className="relative">
      <div className="relative group">
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-accent font-semibold rounded-full transition-all duration-300 hover:bg-primary/20 hover:scale-105 focus:bg-primary/20"
