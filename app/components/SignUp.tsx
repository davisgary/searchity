  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center gap-2 px-4 py-2 bg-zinc-100 text-gray-800 font-semibold rounded-full transition-all duration-300 hover:bg-zinc-300 hover:scale-105"
      >
        <span>Sign Up</span>
      </button>
      {isOpen && !isSignedIn && (
        ...
        >
          <div className="bg-zinc-800 px-8 sm:px-14 py-5 rounded-lg shadow-xl transform transition-all duration-300">
            <button
              ...
              className="absolute top-3 right-4 text-zinc-100 text-lg transform transition-all duration-300 hover:text-zinc-500"
            >
              ✕
            </button>
