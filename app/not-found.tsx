  ...
  return (
    <div className="min-h-screen flex flex-col bg-neutral-900 text-center text-white">
      <div className="w-full max-w-3xl mx-auto flex flex-col items-center justify-start flex-grow py-52">
        <h1 className="text-white/50 font-bold">Oops!</h1>
        ...
        <Link href="/" className="text-normal leading-normal rounded-2xl border border-white px-3 active:bg-transparent transition-all duration-300 hover:scale-105">
          Go Back Home
        </Link>
      </div>
    </div>
